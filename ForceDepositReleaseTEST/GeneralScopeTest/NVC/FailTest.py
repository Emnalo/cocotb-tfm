...
#    await inject_and_check(dut.din, 0b0010, 0b0001, "Fault injection in din") #ZZZ
    await inject_and_check(dut.dout, 0b0000, 0b0001, "Fault injection in dout")
#    await inject_and_check(dut.u_inversor.entrada, 0b0000, 0b0001, "Fault injection in entrada Inversor") #ZZZ
...
#    await inject_and_check(dut.array_constant, 0b1000,0b1111, "Fault injection in array_constant") #Not Implemented
    await inject_and_check(dut.counter, 1, 3, "Fault injection in counter")
