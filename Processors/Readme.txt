Procesadores candidatos como sujetos para campaña de inyección a través de Cocotb. 
	...
	-SignalManagement: Carpeta miscelanea para el manejo de las señales combinacionales y secuenciales + generación de configuraciones json
	...
	-infratestv2.sh: Segunda versión del script bash para generar infraestructura de experimentos. Permite la medición del tiempo, elegir desde donde empezar los test y una trap para medir el tiempo 			
	pasado en caso de salida con CTRL-C. 			
