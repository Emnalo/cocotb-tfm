...
]  # Definir las señales a observar
...
async def dynamic_test(dut):
    ...
    # Inyectar el fallo
    print( len(dut.top.alu.result.value))
    print(dut.top.alu.result.value._type)
    print(dut.top.alu.result[0].value)
    dut.top.alu.result[0].value = Force(1)
    #dut.top.alu.result.value = dut.top.alu.result.value ^ LogicArray("0000000001")
