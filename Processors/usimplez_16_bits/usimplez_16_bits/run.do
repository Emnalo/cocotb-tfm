...
add wave -noupdate -radix unsigned /bench/top/addr_bus_s
...
add wave -noupdate -radix unsigned /bench/top/ram/ram(0)
add wave -noupdate -radix unsigned /bench/top/ram/ram(1)
add wave -noupdate -radix unsigned /bench/top/ram/ram(2)
add wave -noupdate -radix unsigned /bench/top/ram/ram(3)
add wave -noupdate -radix unsigned /bench/top/ram/ram(4)
